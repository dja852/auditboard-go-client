...
func (o *FinancialAccountsPutFinancialAccount) UnmarshalJSON(data []byte) (err error) {
	...
	varFinancialAccountsPutFinancialAccount := _FinancialAccountsPutFinancialAccount{}

	decoder := json.NewDecoder(bytes.NewReader(data))
	decoder.DisallowUnknownFields()
	err = decoder.Decode(&varFinancialAccountsPutFinancialAccount)

	if err != nil {
		return err
	}

	*o = FinancialAccountsPutFinancialAccount(varFinancialAccountsPutFinancialAccount)
