...
// checks if the OpsAuditCategoriesPutOpsAuditCategory type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &OpsAuditCategoriesPutOpsAuditCategory{}

// OpsAuditCategoriesPutOpsAuditCategory struct for OpsAuditCategoriesPutOpsAuditCategory
type OpsAuditCategoriesPutOpsAuditCategory struct {
...
type _OpsAuditCategoriesPutOpsAuditCategory OpsAuditCategoriesPutOpsAuditCategory
...
func NewOpsAuditCategoriesPutOpsAuditCategory(name string, sortOrder int32, status string, workspaceType string, reserved bool) *OpsAuditCategoriesPutOpsAuditCategory {
	this := OpsAuditCategoriesPutOpsAuditCategory{}
	this.Name = name
...
func (o OpsAuditCategoriesPutOpsAuditCategory) MarshalJSON() ([]byte, error) {
...
func (o OpsAuditCategoriesPutOpsAuditCategory) ToMap() (map[string]interface{}, error) {
...
func (o *OpsAuditCategoriesPutOpsAuditCategory) UnmarshalJSON(data []byte) (err error) {
	...
	varOpsAuditCategoriesPutOpsAuditCategory := _OpsAuditCategoriesPutOpsAuditCategory{}

	decoder := json.NewDecoder(bytes.NewReader(data))
	decoder.DisallowUnknownFields()
	err = decoder.Decode(&varOpsAuditCategoriesPutOpsAuditCategory)

	if err != nil {
		return err
	}

	*o = OpsAuditCategoriesPutOpsAuditCategory(varOpsAuditCategoriesPutOpsAuditCategory)

	return err
}

type NullableOpsAuditCategoriesPutOpsAuditCategory struct {
	value *OpsAuditCategoriesPutOpsAuditCategory
	isSet bool
}

func (v NullableOpsAuditCategoriesPutOpsAuditCategory) Get() *OpsAuditCategoriesPutOpsAuditCategory {
	return v.value
}

func (v *NullableOpsAuditCategoriesPutOpsAuditCategory) Set(val *OpsAuditCategoriesPutOpsAuditCategory) {
	v.value = val
	v.isSet = true
}

func (v NullableOpsAuditCategoriesPutOpsAuditCategory) IsSet() bool {
	return v.isSet
}

func (v *NullableOpsAuditCategoriesPutOpsAuditCategory) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableOpsAuditCategoriesPutOpsAuditCategory(val *OpsAuditCategoriesPutOpsAuditCategory) *NullableOpsAuditCategoriesPutOpsAuditCategory {
	return &NullableOpsAuditCategoriesPutOpsAuditCategory{value: val, isSet: true}
}

func (v NullableOpsAuditCategoriesPutOpsAuditCategory) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableOpsAuditCategoriesPutOpsAuditCategory) UnmarshalJSON(src []byte) error {
	v.isSet = true
