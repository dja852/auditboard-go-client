...
func (o *AssessmentTemplates) UnmarshalJSON(data []byte) (err error) {
	...
	varAssessmentTemplates := _AssessmentTemplates{}

	decoder := json.NewDecoder(bytes.NewReader(data))
	decoder.DisallowUnknownFields()
	err = decoder.Decode(&varAssessmentTemplates)

	if err != nil {
		return err
	}

	*o = AssessmentTemplates(varAssessmentTemplates)
