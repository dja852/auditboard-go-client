...
func (o *RcwRequestCategories) UnmarshalJSON(data []byte) (err error) {
	...
	varRcwRequestCategories := _RcwRequestCategories{}

	decoder := json.NewDecoder(bytes.NewReader(data))
	decoder.DisallowUnknownFields()
	err = decoder.Decode(&varRcwRequestCategories)

	if err != nil {
		return err
	}

	*o = RcwRequestCategories(varRcwRequestCategories)
