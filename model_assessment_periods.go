...
func (o *AssessmentPeriods) UnmarshalJSON(data []byte) (err error) {
	...
	varAssessmentPeriods := _AssessmentPeriods{}

	decoder := json.NewDecoder(bytes.NewReader(data))
	decoder.DisallowUnknownFields()
	err = decoder.Decode(&varAssessmentPeriods)

	if err != nil {
		return err
	}

	*o = AssessmentPeriods(varAssessmentPeriods)
