...
func (o *EsgMetricAuditableEntities) UnmarshalJSON(data []byte) (err error) {
	...
	varEsgMetricAuditableEntities := _EsgMetricAuditableEntities{}

	decoder := json.NewDecoder(bytes.NewReader(data))
	decoder.DisallowUnknownFields()
	err = decoder.Decode(&varEsgMetricAuditableEntities)

	if err != nil {
		return err
	}

	*o = EsgMetricAuditableEntities(varEsgMetricAuditableEntities)
