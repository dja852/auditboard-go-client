...
func (o *AssessmentResponses) UnmarshalJSON(data []byte) (err error) {
	...
	varAssessmentResponses := _AssessmentResponses{}

	decoder := json.NewDecoder(bytes.NewReader(data))
	decoder.DisallowUnknownFields()
	err = decoder.Decode(&varAssessmentResponses)

	if err != nil {
		return err
	}

	*o = AssessmentResponses(varAssessmentResponses)
