...
func (o *ControlsPutControl) UnmarshalJSON(data []byte) (err error) {
	...
	varControlsPutControl := _ControlsPutControl{}

	decoder := json.NewDecoder(bytes.NewReader(data))
	decoder.DisallowUnknownFields()
	err = decoder.Decode(&varControlsPutControl)

	if err != nil {
		return err
	}

	*o = ControlsPutControl(varControlsPutControl)
