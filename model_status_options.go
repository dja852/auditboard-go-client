...
func (o *StatusOptions) UnmarshalJSON(data []byte) (err error) {
	...
	varStatusOptions := _StatusOptions{}

	decoder := json.NewDecoder(bytes.NewReader(data))
	decoder.DisallowUnknownFields()
	err = decoder.Decode(&varStatusOptions)

	if err != nil {
		return err
	}

	*o = StatusOptions(varStatusOptions)
