...
func (o *TeamPermissionsPutTeamPermission) UnmarshalJSON(data []byte) (err error) {
	...
	varTeamPermissionsPutTeamPermission := _TeamPermissionsPutTeamPermission{}

	decoder := json.NewDecoder(bytes.NewReader(data))
	decoder.DisallowUnknownFields()
	err = decoder.Decode(&varTeamPermissionsPutTeamPermission)

	if err != nil {
		return err
	}

	*o = TeamPermissionsPutTeamPermission(varTeamPermissionsPutTeamPermission)
