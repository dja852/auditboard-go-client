...
func (o *GlobalPermissions) UnmarshalJSON(data []byte) (err error) {
	...
	varGlobalPermissions := _GlobalPermissions{}

	decoder := json.NewDecoder(bytes.NewReader(data))
	decoder.DisallowUnknownFields()
	err = decoder.Decode(&varGlobalPermissions)

	if err != nil {
		return err
	}

	*o = GlobalPermissions(varGlobalPermissions)
