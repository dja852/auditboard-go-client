...
// checks if the NarrativesPutPreviousValues type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &NarrativesPutPreviousValues{}

// NarrativesPutPreviousValues struct for NarrativesPutPreviousValues
type NarrativesPutPreviousValues struct {
...
func NewNarrativesPutPreviousValues() *NarrativesPutPreviousValues {
	this := NarrativesPutPreviousValues{}
	return &this
}
...
func (o NarrativesPutPreviousValues) MarshalJSON() ([]byte, error) {
...
func (o NarrativesPutPreviousValues) ToMap() (map[string]interface{}, error) {
...
type NullableNarrativesPutPreviousValues struct {
	value *NarrativesPutPreviousValues
	isSet bool
}

func (v NullableNarrativesPutPreviousValues) Get() *NarrativesPutPreviousValues {
	return v.value
}

func (v *NullableNarrativesPutPreviousValues) Set(val *NarrativesPutPreviousValues) {
	v.value = val
	v.isSet = true
}

func (v NullableNarrativesPutPreviousValues) IsSet() bool {
	return v.isSet
}

func (v *NullableNarrativesPutPreviousValues) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableNarrativesPutPreviousValues(val *NarrativesPutPreviousValues) *NullableNarrativesPutPreviousValues {
	return &NullableNarrativesPutPreviousValues{value: val, isSet: true}
}

func (v NullableNarrativesPutPreviousValues) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableNarrativesPutPreviousValues) UnmarshalJSON(src []byte) error {
	v.isSet = true
