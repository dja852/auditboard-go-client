...
// checks if the AssessmentPeriodsPutAssessmentPeriod type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &AssessmentPeriodsPutAssessmentPeriod{}

// AssessmentPeriodsPutAssessmentPeriod struct for AssessmentPeriodsPutAssessmentPeriod
type AssessmentPeriodsPutAssessmentPeriod struct {
...
type _AssessmentPeriodsPutAssessmentPeriod AssessmentPeriodsPutAssessmentPeriod
...
func NewAssessmentPeriodsPutAssessmentPeriod(name string, sortOrder int32) *AssessmentPeriodsPutAssessmentPeriod {
	this := AssessmentPeriodsPutAssessmentPeriod{}
	this.Name = name
...
func (o AssessmentPeriodsPutAssessmentPeriod) MarshalJSON() ([]byte, error) {
...
func (o AssessmentPeriodsPutAssessmentPeriod) ToMap() (map[string]interface{}, error) {
...
func (o *AssessmentPeriodsPutAssessmentPeriod) UnmarshalJSON(data []byte) (err error) {
	...
	varAssessmentPeriodsPutAssessmentPeriod := _AssessmentPeriodsPutAssessmentPeriod{}

	decoder := json.NewDecoder(bytes.NewReader(data))
	decoder.DisallowUnknownFields()
	err = decoder.Decode(&varAssessmentPeriodsPutAssessmentPeriod)

	if err != nil {
		return err
	}

	*o = AssessmentPeriodsPutAssessmentPeriod(varAssessmentPeriodsPutAssessmentPeriod)

	return err
}

type NullableAssessmentPeriodsPutAssessmentPeriod struct {
	value *AssessmentPeriodsPutAssessmentPeriod
	isSet bool
}

func (v NullableAssessmentPeriodsPutAssessmentPeriod) Get() *AssessmentPeriodsPutAssessmentPeriod {
	return v.value
}

func (v *NullableAssessmentPeriodsPutAssessmentPeriod) Set(val *AssessmentPeriodsPutAssessmentPeriod) {
	v.value = val
	v.isSet = true
}

func (v NullableAssessmentPeriodsPutAssessmentPeriod) IsSet() bool {
	return v.isSet
}

func (v *NullableAssessmentPeriodsPutAssessmentPeriod) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableAssessmentPeriodsPutAssessmentPeriod(val *AssessmentPeriodsPutAssessmentPeriod) *NullableAssessmentPeriodsPutAssessmentPeriod {
	return &NullableAssessmentPeriodsPutAssessmentPeriod{value: val, isSet: true}
}

func (v NullableAssessmentPeriodsPutAssessmentPeriod) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableAssessmentPeriodsPutAssessmentPeriod) UnmarshalJSON(src []byte) error {
	v.isSet = true
