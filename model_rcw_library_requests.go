...
// checks if the RcwLibraryRequests type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &RcwLibraryRequests{}

// RcwLibraryRequests struct for RcwLibraryRequests
type RcwLibraryRequests struct {
...
type _RcwLibraryRequests RcwLibraryRequests
...
func (o RcwLibraryRequests) MarshalJSON() ([]byte, error) {
...
func (o RcwLibraryRequests) ToMap() (map[string]interface{}, error) {
...
func (o *RcwLibraryRequests) UnmarshalJSON(data []byte) (err error) {
	...
	varRcwLibraryRequests := _RcwLibraryRequests{}

	decoder := json.NewDecoder(bytes.NewReader(data))
	decoder.DisallowUnknownFields()
	err = decoder.Decode(&varRcwLibraryRequests)

	if err != nil {
		return err
	}

	*o = RcwLibraryRequests(varRcwLibraryRequests)

	return err
}

type NullableRcwLibraryRequests struct {
	value *RcwLibraryRequests
	isSet bool
}

func (v NullableRcwLibraryRequests) Get() *RcwLibraryRequests {
	return v.value
}

func (v *NullableRcwLibraryRequests) Set(val *RcwLibraryRequests) {
	v.value = val
	v.isSet = true
}

func (v NullableRcwLibraryRequests) IsSet() bool {
	return v.isSet
}

func (v *NullableRcwLibraryRequests) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableRcwLibraryRequests(val *RcwLibraryRequests) *NullableRcwLibraryRequests {
	return &NullableRcwLibraryRequests{value: val, isSet: true}
}

func (v NullableRcwLibraryRequests) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableRcwLibraryRequests) UnmarshalJSON(src []byte) error {
	v.isSet = true
