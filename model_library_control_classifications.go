...
// checks if the LibraryControlClassifications type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &LibraryControlClassifications{}

// LibraryControlClassifications struct for LibraryControlClassifications
type LibraryControlClassifications struct {
...
type _LibraryControlClassifications LibraryControlClassifications
...
func NewLibraryControlClassifications(name string, sortOrder int32) *LibraryControlClassifications {
	this := LibraryControlClassifications{}
	this.Name = name
...
func (o LibraryControlClassifications) MarshalJSON() ([]byte, error) {
...
func (o LibraryControlClassifications) ToMap() (map[string]interface{}, error) {
...
func (o *LibraryControlClassifications) UnmarshalJSON(data []byte) (err error) {
	...
	varLibraryControlClassifications := _LibraryControlClassifications{}

	decoder := json.NewDecoder(bytes.NewReader(data))
	decoder.DisallowUnknownFields()
	err = decoder.Decode(&varLibraryControlClassifications)

	if err != nil {
		return err
	}

	*o = LibraryControlClassifications(varLibraryControlClassifications)

	return err
}

type NullableLibraryControlClassifications struct {
	value *LibraryControlClassifications
	isSet bool
}

func (v NullableLibraryControlClassifications) Get() *LibraryControlClassifications {
	return v.value
}

func (v *NullableLibraryControlClassifications) Set(val *LibraryControlClassifications) {
	v.value = val
	v.isSet = true
}

func (v NullableLibraryControlClassifications) IsSet() bool {
	return v.isSet
}

func (v *NullableLibraryControlClassifications) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableLibraryControlClassifications(val *LibraryControlClassifications) *NullableLibraryControlClassifications {
	return &NullableLibraryControlClassifications{value: val, isSet: true}
}

func (v NullableLibraryControlClassifications) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableLibraryControlClassifications) UnmarshalJSON(src []byte) error {
	v.isSet = true
