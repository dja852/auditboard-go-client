...
func (o *EsgMetricValueAggregates) UnmarshalJSON(data []byte) (err error) {
	...
	varEsgMetricValueAggregates := _EsgMetricValueAggregates{}

	decoder := json.NewDecoder(bytes.NewReader(data))
	decoder.DisallowUnknownFields()
	err = decoder.Decode(&varEsgMetricValueAggregates)

	if err != nil {
		return err
	}

	*o = EsgMetricValueAggregates(varEsgMetricValueAggregates)
