...
func (o *LibraryControlTypes) UnmarshalJSON(data []byte) (err error) {
	...
	varLibraryControlTypes := _LibraryControlTypes{}

	decoder := json.NewDecoder(bytes.NewReader(data))
	decoder.DisallowUnknownFields()
	err = decoder.Decode(&varLibraryControlTypes)

	if err != nil {
		return err
	}

	*o = LibraryControlTypes(varLibraryControlTypes)
