...
func (o *RiskTypesPutRiskType) UnmarshalJSON(data []byte) (err error) {
	...
	varRiskTypesPutRiskType := _RiskTypesPutRiskType{}

	decoder := json.NewDecoder(bytes.NewReader(data))
	decoder.DisallowUnknownFields()
	err = decoder.Decode(&varRiskTypesPutRiskType)

	if err != nil {
		return err
	}

	*o = RiskTypesPutRiskType(varRiskTypesPutRiskType)
