...
func (o *ReportsPutReport) UnmarshalJSON(data []byte) (err error) {
	...
	varReportsPutReport := _ReportsPutReport{}

	decoder := json.NewDecoder(bytes.NewReader(data))
	decoder.DisallowUnknownFields()
	err = decoder.Decode(&varReportsPutReport)

	if err != nil {
		return err
	}

	*o = ReportsPutReport(varReportsPutReport)
