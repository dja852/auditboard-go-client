...
// checks if the RcwRequestsPutRcwRequest type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &RcwRequestsPutRcwRequest{}

// RcwRequestsPutRcwRequest struct for RcwRequestsPutRcwRequest
type RcwRequestsPutRcwRequest struct {
...
type _RcwRequestsPutRcwRequest RcwRequestsPutRcwRequest
...
func (o RcwRequestsPutRcwRequest) MarshalJSON() ([]byte, error) {
...
func (o RcwRequestsPutRcwRequest) ToMap() (map[string]interface{}, error) {
...
func (o *RcwRequestsPutRcwRequest) UnmarshalJSON(data []byte) (err error) {
	...
	varRcwRequestsPutRcwRequest := _RcwRequestsPutRcwRequest{}

	decoder := json.NewDecoder(bytes.NewReader(data))
	decoder.DisallowUnknownFields()
	err = decoder.Decode(&varRcwRequestsPutRcwRequest)

	if err != nil {
		return err
	}

	*o = RcwRequestsPutRcwRequest(varRcwRequestsPutRcwRequest)

	return err
}

type NullableRcwRequestsPutRcwRequest struct {
	value *RcwRequestsPutRcwRequest
	isSet bool
}

func (v NullableRcwRequestsPutRcwRequest) Get() *RcwRequestsPutRcwRequest {
	return v.value
}

func (v *NullableRcwRequestsPutRcwRequest) Set(val *RcwRequestsPutRcwRequest) {
	v.value = val
	v.isSet = true
}

func (v NullableRcwRequestsPutRcwRequest) IsSet() bool {
	return v.isSet
}

func (v *NullableRcwRequestsPutRcwRequest) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableRcwRequestsPutRcwRequest(val *RcwRequestsPutRcwRequest) *NullableRcwRequestsPutRcwRequest {
	return &NullableRcwRequestsPutRcwRequest{value: val, isSet: true}
}

func (v NullableRcwRequestsPutRcwRequest) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableRcwRequestsPutRcwRequest) UnmarshalJSON(src []byte) error {
	v.isSet = true
