...
func (o *FrameworkItems) UnmarshalJSON(data []byte) (err error) {
	...
	varFrameworkItems := _FrameworkItems{}

	decoder := json.NewDecoder(bytes.NewReader(data))
	decoder.DisallowUnknownFields()
	err = decoder.Decode(&varFrameworkItems)

	if err != nil {
		return err
	}

	*o = FrameworkItems(varFrameworkItems)
