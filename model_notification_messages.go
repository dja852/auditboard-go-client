...
func (o *NotificationMessages) UnmarshalJSON(data []byte) (err error) {
	...
	varNotificationMessages := _NotificationMessages{}

	decoder := json.NewDecoder(bytes.NewReader(data))
	decoder.DisallowUnknownFields()
	err = decoder.Decode(&varNotificationMessages)

	if err != nil {
		return err
	}

	*o = NotificationMessages(varNotificationMessages)
