...
func (o *AuditOfficeLocations) UnmarshalJSON(data []byte) (err error) {
	...
	varAuditOfficeLocations := _AuditOfficeLocations{}

	decoder := json.NewDecoder(bytes.NewReader(data))
	decoder.DisallowUnknownFields()
	err = decoder.Decode(&varAuditOfficeLocations)

	if err != nil {
		return err
	}

	*o = AuditOfficeLocations(varAuditOfficeLocations)
