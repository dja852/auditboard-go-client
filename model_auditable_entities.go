...
func (o *AuditableEntities) UnmarshalJSON(data []byte) (err error) {
	...
	varAuditableEntities := _AuditableEntities{}

	decoder := json.NewDecoder(bytes.NewReader(data))
	decoder.DisallowUnknownFields()
	err = decoder.Decode(&varAuditableEntities)

	if err != nil {
		return err
	}

	*o = AuditableEntities(varAuditableEntities)
