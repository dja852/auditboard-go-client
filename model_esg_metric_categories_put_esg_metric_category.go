...
func (o *EsgMetricCategoriesPutEsgMetricCategory) UnmarshalJSON(data []byte) (err error) {
	...
	varEsgMetricCategoriesPutEsgMetricCategory := _EsgMetricCategoriesPutEsgMetricCategory{}

	decoder := json.NewDecoder(bytes.NewReader(data))
	decoder.DisallowUnknownFields()
	err = decoder.Decode(&varEsgMetricCategoriesPutEsgMetricCategory)

	if err != nil {
		return err
	}

	*o = EsgMetricCategoriesPutEsgMetricCategory(varEsgMetricCategoriesPutEsgMetricCategory)
