...
func (o *EsgMetricConversionFactorsPutEsgMetricConversionFactor) UnmarshalJSON(data []byte) (err error) {
	...
	varEsgMetricConversionFactorsPutEsgMetricConversionFactor := _EsgMetricConversionFactorsPutEsgMetricConversionFactor{}

	decoder := json.NewDecoder(bytes.NewReader(data))
	decoder.DisallowUnknownFields()
	err = decoder.Decode(&varEsgMetricConversionFactorsPutEsgMetricConversionFactor)

	if err != nil {
		return err
	}

	*o = EsgMetricConversionFactorsPutEsgMetricConversionFactor(varEsgMetricConversionFactorsPutEsgMetricConversionFactor)
