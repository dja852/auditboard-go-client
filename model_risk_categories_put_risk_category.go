...
func (o *RiskCategoriesPutRiskCategory) UnmarshalJSON(data []byte) (err error) {
	...
	varRiskCategoriesPutRiskCategory := _RiskCategoriesPutRiskCategory{}

	decoder := json.NewDecoder(bytes.NewReader(data))
	decoder.DisallowUnknownFields()
	err = decoder.Decode(&varRiskCategoriesPutRiskCategory)

	if err != nil {
		return err
	}

	*o = RiskCategoriesPutRiskCategory(varRiskCategoriesPutRiskCategory)
