...
func (o *IssuesArchives) UnmarshalJSON(data []byte) (err error) {
	...
	varIssuesArchives := _IssuesArchives{}

	decoder := json.NewDecoder(bytes.NewReader(data))
	decoder.DisallowUnknownFields()
	err = decoder.Decode(&varIssuesArchives)

	if err != nil {
		return err
	}

	*o = IssuesArchives(varIssuesArchives)
