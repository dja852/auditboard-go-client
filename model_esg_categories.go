...
func (o *EsgCategories) UnmarshalJSON(data []byte) (err error) {
	...
	varEsgCategories := _EsgCategories{}

	decoder := json.NewDecoder(bytes.NewReader(data))
	decoder.DisallowUnknownFields()
	err = decoder.Decode(&varEsgCategories)

	if err != nil {
		return err
	}

	*o = EsgCategories(varEsgCategories)
