...
func (o *RcwLibraryRequestsPutRcwLibraryRequest) UnmarshalJSON(data []byte) (err error) {
	...
	varRcwLibraryRequestsPutRcwLibraryRequest := _RcwLibraryRequestsPutRcwLibraryRequest{}

	decoder := json.NewDecoder(bytes.NewReader(data))
	decoder.DisallowUnknownFields()
	err = decoder.Decode(&varRcwLibraryRequestsPutRcwLibraryRequest)

	if err != nil {
		return err
	}

	*o = RcwLibraryRequestsPutRcwLibraryRequest(varRcwLibraryRequestsPutRcwLibraryRequest)
