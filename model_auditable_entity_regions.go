...
func (o *AuditableEntityRegions) UnmarshalJSON(data []byte) (err error) {
	...
	varAuditableEntityRegions := _AuditableEntityRegions{}

	decoder := json.NewDecoder(bytes.NewReader(data))
	decoder.DisallowUnknownFields()
	err = decoder.Decode(&varAuditableEntityRegions)

	if err != nil {
		return err
	}

	*o = AuditableEntityRegions(varAuditableEntityRegions)
