...
func (o *TaskItemsPutTaskItem) UnmarshalJSON(data []byte) (err error) {
	...
	varTaskItemsPutTaskItem := _TaskItemsPutTaskItem{}

	decoder := json.NewDecoder(bytes.NewReader(data))
	decoder.DisallowUnknownFields()
	err = decoder.Decode(&varTaskItemsPutTaskItem)

	if err != nil {
		return err
	}

	*o = TaskItemsPutTaskItem(varTaskItemsPutTaskItem)
