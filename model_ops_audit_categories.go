...
func (o *OpsAuditCategories) UnmarshalJSON(data []byte) (err error) {
	...
	varOpsAuditCategories := _OpsAuditCategories{}

	decoder := json.NewDecoder(bytes.NewReader(data))
	decoder.DisallowUnknownFields()
	err = decoder.Decode(&varOpsAuditCategories)

	if err != nil {
		return err
	}

	*o = OpsAuditCategories(varOpsAuditCategories)
