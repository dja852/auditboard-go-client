...
func (o *AuditBusinessSegments) UnmarshalJSON(data []byte) (err error) {
	...
	varAuditBusinessSegments := _AuditBusinessSegments{}

	decoder := json.NewDecoder(bytes.NewReader(data))
	decoder.DisallowUnknownFields()
	err = decoder.Decode(&varAuditBusinessSegments)

	if err != nil {
		return err
	}

	*o = AuditBusinessSegments(varAuditBusinessSegments)
