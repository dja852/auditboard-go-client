...
func (o *AuditableEntityTypesPutAuditableEntityType) UnmarshalJSON(data []byte) (err error) {
	...
	varAuditableEntityTypesPutAuditableEntityType := _AuditableEntityTypesPutAuditableEntityType{}

	decoder := json.NewDecoder(bytes.NewReader(data))
	decoder.DisallowUnknownFields()
	err = decoder.Decode(&varAuditableEntityTypesPutAuditableEntityType)

	if err != nil {
		return err
	}

	*o = AuditableEntityTypesPutAuditableEntityType(varAuditableEntityTypesPutAuditableEntityType)
