...
// checks if the TimesheetEntriesPutTimesheetEntry type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &TimesheetEntriesPutTimesheetEntry{}

// TimesheetEntriesPutTimesheetEntry struct for TimesheetEntriesPutTimesheetEntry
type TimesheetEntriesPutTimesheetEntry struct {
...
type _TimesheetEntriesPutTimesheetEntry TimesheetEntriesPutTimesheetEntry
...
func NewTimesheetEntriesPutTimesheetEntry(date string, hours float32, userId int32, timesheetableType string, timesheetableId int32, timesheetProjectId int32) *TimesheetEntriesPutTimesheetEntry {
	this := TimesheetEntriesPutTimesheetEntry{}
	this.Date = date
	this.Hours = hours
	this.UserId = userId
...
func (o TimesheetEntriesPutTimesheetEntry) MarshalJSON() ([]byte, error) {
...
func (o TimesheetEntriesPutTimesheetEntry) ToMap() (map[string]interface{}, error) {
...
func (o *TimesheetEntriesPutTimesheetEntry) UnmarshalJSON(data []byte) (err error) {
	...
	varTimesheetEntriesPutTimesheetEntry := _TimesheetEntriesPutTimesheetEntry{}

	decoder := json.NewDecoder(bytes.NewReader(data))
	decoder.DisallowUnknownFields()
	err = decoder.Decode(&varTimesheetEntriesPutTimesheetEntry)

	if err != nil {
		return err
	}

	*o = TimesheetEntriesPutTimesheetEntry(varTimesheetEntriesPutTimesheetEntry)

	return err
}

type NullableTimesheetEntriesPutTimesheetEntry struct {
	value *TimesheetEntriesPutTimesheetEntry
	isSet bool
}

func (v NullableTimesheetEntriesPutTimesheetEntry) Get() *TimesheetEntriesPutTimesheetEntry {
	return v.value
}

func (v *NullableTimesheetEntriesPutTimesheetEntry) Set(val *TimesheetEntriesPutTimesheetEntry) {
	v.value = val
	v.isSet = true
}

func (v NullableTimesheetEntriesPutTimesheetEntry) IsSet() bool {
	return v.isSet
}

func (v *NullableTimesheetEntriesPutTimesheetEntry) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableTimesheetEntriesPutTimesheetEntry(val *TimesheetEntriesPutTimesheetEntry) *NullableTimesheetEntriesPutTimesheetEntry {
	return &NullableTimesheetEntriesPutTimesheetEntry{value: val, isSet: true}
}

func (v NullableTimesheetEntriesPutTimesheetEntry) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableTimesheetEntriesPutTimesheetEntry) UnmarshalJSON(src []byte) error {
	v.isSet = true
