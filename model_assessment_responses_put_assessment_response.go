...
func (o *AssessmentResponsesPutAssessmentResponse) UnmarshalJSON(data []byte) (err error) {
	...
	varAssessmentResponsesPutAssessmentResponse := _AssessmentResponsesPutAssessmentResponse{}

	decoder := json.NewDecoder(bytes.NewReader(data))
	decoder.DisallowUnknownFields()
	err = decoder.Decode(&varAssessmentResponsesPutAssessmentResponse)

	if err != nil {
		return err
	}

	*o = AssessmentResponsesPutAssessmentResponse(varAssessmentResponsesPutAssessmentResponse)
