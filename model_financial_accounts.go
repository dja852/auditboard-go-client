...
// checks if the FinancialAccounts type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &FinancialAccounts{}
...
type _FinancialAccounts FinancialAccounts
...
func (o FinancialAccounts) ToMap() (map[string]interface{}, error) {
...
func (o *FinancialAccounts) UnmarshalJSON(data []byte) (err error) {
	...
	varFinancialAccounts := _FinancialAccounts{}

	decoder := json.NewDecoder(bytes.NewReader(data))
	decoder.DisallowUnknownFields()
	err = decoder.Decode(&varFinancialAccounts)

	if err != nil {
		return err
	}

	*o = FinancialAccounts(varFinancialAccounts)
