...
// checks if the OpsAuditsPutPreviousValues type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &OpsAuditsPutPreviousValues{}

// OpsAuditsPutPreviousValues struct for OpsAuditsPutPreviousValues
type OpsAuditsPutPreviousValues struct {
	...
	IsRiskAssessmentEnabled *bool `json:"is_risk_assessment_enabled,omitempty"`
...
func NewOpsAuditsPutPreviousValues() *OpsAuditsPutPreviousValues {
	this := OpsAuditsPutPreviousValues{}
...
// GetIsRiskAssessmentEnabled returns the IsRiskAssessmentEnabled field value if set, zero value otherwise.
func (o *OpsAuditsPutPreviousValues) GetIsRiskAssessmentEnabled() bool {
	if o == nil || IsNil(o.IsRiskAssessmentEnabled) {
		var ret bool
		return ret
	}
...
// GetIsRiskAssessmentEnabledOk returns a tuple with the IsRiskAssessmentEnabled field value if set, nil otherwise
// and a boolean to check if the value has been set.
...
// SetIsRiskAssessmentEnabled gets a reference to the given bool and assigns it to the IsRiskAssessmentEnabled field.
...
func (o OpsAuditsPutPreviousValues) MarshalJSON() ([]byte, error) {
...
func (o OpsAuditsPutPreviousValues) ToMap() (map[string]interface{}, error) {
	...
	if !IsNil(o.IsRiskAssessmentEnabled) {
...
type NullableOpsAuditsPutPreviousValues struct {
	value *OpsAuditsPutPreviousValues
	isSet bool
}

func (v NullableOpsAuditsPutPreviousValues) Get() *OpsAuditsPutPreviousValues {
	return v.value
}

func (v *NullableOpsAuditsPutPreviousValues) Set(val *OpsAuditsPutPreviousValues) {
	v.value = val
	v.isSet = true
}

func (v NullableOpsAuditsPutPreviousValues) IsSet() bool {
	return v.isSet
}

func (v *NullableOpsAuditsPutPreviousValues) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableOpsAuditsPutPreviousValues(val *OpsAuditsPutPreviousValues) *NullableOpsAuditsPutPreviousValues {
	return &NullableOpsAuditsPutPreviousValues{value: val, isSet: true}
}

func (v NullableOpsAuditsPutPreviousValues) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableOpsAuditsPutPreviousValues) UnmarshalJSON(src []byte) error {
	v.isSet = true
