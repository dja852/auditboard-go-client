...
func (o *FileVersionsPutFileVersion) UnmarshalJSON(data []byte) (err error) {
	...
	varFileVersionsPutFileVersion := _FileVersionsPutFileVersion{}

	decoder := json.NewDecoder(bytes.NewReader(data))
	decoder.DisallowUnknownFields()
	err = decoder.Decode(&varFileVersionsPutFileVersion)

	if err != nil {
		return err
	}

	*o = FileVersionsPutFileVersion(varFileVersionsPutFileVersion)
