...
func (o *CustomFieldsPutCustomField) UnmarshalJSON(data []byte) (err error) {
	...
	varCustomFieldsPutCustomField := _CustomFieldsPutCustomField{}

	decoder := json.NewDecoder(bytes.NewReader(data))
	decoder.DisallowUnknownFields()
	err = decoder.Decode(&varCustomFieldsPutCustomField)

	if err != nil {
		return err
	}

	*o = CustomFieldsPutCustomField(varCustomFieldsPutCustomField)
