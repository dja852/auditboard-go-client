...
func (o *SurveysPutSurvey) UnmarshalJSON(data []byte) (err error) {
	...
	varSurveysPutSurvey := _SurveysPutSurvey{}

	decoder := json.NewDecoder(bytes.NewReader(data))
	decoder.DisallowUnknownFields()
	err = decoder.Decode(&varSurveysPutSurvey)

	if err != nil {
		return err
	}

	*o = SurveysPutSurvey(varSurveysPutSurvey)
