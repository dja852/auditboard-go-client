...
func (o *GlobalPermissionsPutGlobalPermission) UnmarshalJSON(data []byte) (err error) {
	...
	varGlobalPermissionsPutGlobalPermission := _GlobalPermissionsPutGlobalPermission{}

	decoder := json.NewDecoder(bytes.NewReader(data))
	decoder.DisallowUnknownFields()
	err = decoder.Decode(&varGlobalPermissionsPutGlobalPermission)

	if err != nil {
		return err
	}

	*o = GlobalPermissionsPutGlobalPermission(varGlobalPermissionsPutGlobalPermission)
