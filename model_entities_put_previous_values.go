...
// checks if the EntitiesPutPreviousValues type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &EntitiesPutPreviousValues{}

// EntitiesPutPreviousValues struct for EntitiesPutPreviousValues
type EntitiesPutPreviousValues struct {
...
func NewEntitiesPutPreviousValues() *EntitiesPutPreviousValues {
	this := EntitiesPutPreviousValues{}
...
func (o EntitiesPutPreviousValues) MarshalJSON() ([]byte, error) {
...
func (o EntitiesPutPreviousValues) ToMap() (map[string]interface{}, error) {
...
type NullableEntitiesPutPreviousValues struct {
	value *EntitiesPutPreviousValues
	isSet bool
}

func (v NullableEntitiesPutPreviousValues) Get() *EntitiesPutPreviousValues {
	return v.value
}

func (v *NullableEntitiesPutPreviousValues) Set(val *EntitiesPutPreviousValues) {
	v.value = val
	v.isSet = true
}

func (v NullableEntitiesPutPreviousValues) IsSet() bool {
	return v.isSet
}

func (v *NullableEntitiesPutPreviousValues) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableEntitiesPutPreviousValues(val *EntitiesPutPreviousValues) *NullableEntitiesPutPreviousValues {
	return &NullableEntitiesPutPreviousValues{value: val, isSet: true}
}

func (v NullableEntitiesPutPreviousValues) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableEntitiesPutPreviousValues) UnmarshalJSON(src []byte) error {
	v.isSet = true
