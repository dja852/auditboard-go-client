...
// checks if the RiskCategories type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &RiskCategories{}

// RiskCategories struct for RiskCategories
...
type _RiskCategories RiskCategories
...
func (o RiskCategories) MarshalJSON() ([]byte, error) {
...
func (o RiskCategories) ToMap() (map[string]interface{}, error) {
...
func (o *RiskCategories) UnmarshalJSON(data []byte) (err error) {
	...
	varRiskCategories := _RiskCategories{}

	decoder := json.NewDecoder(bytes.NewReader(data))
	decoder.DisallowUnknownFields()
	err = decoder.Decode(&varRiskCategories)

	if err != nil {
		return err
	}

	*o = RiskCategories(varRiskCategories)

	return err
}

type NullableRiskCategories struct {
	value *RiskCategories
	isSet bool
}

func (v NullableRiskCategories) Get() *RiskCategories {
	return v.value
}

func (v *NullableRiskCategories) Set(val *RiskCategories) {
	v.value = val
	v.isSet = true
}

func (v NullableRiskCategories) IsSet() bool {
	return v.isSet
}

func (v *NullableRiskCategories) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableRiskCategories(val *RiskCategories) *NullableRiskCategories {
	return &NullableRiskCategories{value: val, isSet: true}
}

func (v NullableRiskCategories) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableRiskCategories) UnmarshalJSON(src []byte) error {
	v.isSet = true
