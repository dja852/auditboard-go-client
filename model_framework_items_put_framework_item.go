...
func (o *FrameworkItemsPutFrameworkItem) UnmarshalJSON(data []byte) (err error) {
	...
	varFrameworkItemsPutFrameworkItem := _FrameworkItemsPutFrameworkItem{}

	decoder := json.NewDecoder(bytes.NewReader(data))
	decoder.DisallowUnknownFields()
	err = decoder.Decode(&varFrameworkItemsPutFrameworkItem)

	if err != nil {
		return err
	}

	*o = FrameworkItemsPutFrameworkItem(varFrameworkItemsPutFrameworkItem)
