...
// checks if the ActionPlansPutPreviousValues type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &ActionPlansPutPreviousValues{}

// ActionPlansPutPreviousValues struct for ActionPlansPutPreviousValues
type ActionPlansPutPreviousValues struct {
	...
	PendingRemediationDueDateCount *int32 `json:"pending_remediation_due_date_count,omitempty"`
...
func NewActionPlansPutPreviousValues() *ActionPlansPutPreviousValues {
	this := ActionPlansPutPreviousValues{}
...
// GetPendingRemediationDueDateCount returns the PendingRemediationDueDateCount field value if set, zero value otherwise.
func (o *ActionPlansPutPreviousValues) GetPendingRemediationDueDateCount() int32 {
	if o == nil || IsNil(o.PendingRemediationDueDateCount) {
		var ret int32
		return ret
	}
...
// GetPendingRemediationDueDateCountOk returns a tuple with the PendingRemediationDueDateCount field value if set, nil otherwise
// and a boolean to check if the value has been set.
...
// SetPendingRemediationDueDateCount gets a reference to the given int32 and assigns it to the PendingRemediationDueDateCount field.
...
func (o ActionPlansPutPreviousValues) MarshalJSON() ([]byte, error) {
...
func (o ActionPlansPutPreviousValues) ToMap() (map[string]interface{}, error) {
	...
	if !IsNil(o.PendingRemediationDueDateCount) {
...
type NullableActionPlansPutPreviousValues struct {
	value *ActionPlansPutPreviousValues
	isSet bool
}

func (v NullableActionPlansPutPreviousValues) Get() *ActionPlansPutPreviousValues {
	return v.value
}

func (v *NullableActionPlansPutPreviousValues) Set(val *ActionPlansPutPreviousValues) {
	v.value = val
	v.isSet = true
}

func (v NullableActionPlansPutPreviousValues) IsSet() bool {
	return v.isSet
}

func (v *NullableActionPlansPutPreviousValues) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableActionPlansPutPreviousValues(val *ActionPlansPutPreviousValues) *NullableActionPlansPutPreviousValues {
	return &NullableActionPlansPutPreviousValues{value: val, isSet: true}
}

func (v NullableActionPlansPutPreviousValues) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableActionPlansPutPreviousValues) UnmarshalJSON(src []byte) error {
	v.isSet = true
