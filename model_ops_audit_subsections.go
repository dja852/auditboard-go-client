...
func (o *OpsAuditSubsections) UnmarshalJSON(data []byte) (err error) {
	...
	varOpsAuditSubsections := _OpsAuditSubsections{}

	decoder := json.NewDecoder(bytes.NewReader(data))
	decoder.DisallowUnknownFields()
	err = decoder.Decode(&varOpsAuditSubsections)

	if err != nil {
		return err
	}

	*o = OpsAuditSubsections(varOpsAuditSubsections)
