...
func (o *ControlsDataArchivesPutControlsDataArchive) UnmarshalJSON(data []byte) (err error) {
	...
	varControlsDataArchivesPutControlsDataArchive := _ControlsDataArchivesPutControlsDataArchive{}

	decoder := json.NewDecoder(bytes.NewReader(data))
	decoder.DisallowUnknownFields()
	err = decoder.Decode(&varControlsDataArchivesPutControlsDataArchive)

	if err != nil {
		return err
	}

	*o = ControlsDataArchivesPutControlsDataArchive(varControlsDataArchivesPutControlsDataArchive)
