...
func (o *StatusOptionsPutStatusOption) UnmarshalJSON(data []byte) (err error) {
	...
	varStatusOptionsPutStatusOption := _StatusOptionsPutStatusOption{}

	decoder := json.NewDecoder(bytes.NewReader(data))
	decoder.DisallowUnknownFields()
	err = decoder.Decode(&varStatusOptionsPutStatusOption)

	if err != nil {
		return err
	}

	*o = StatusOptionsPutStatusOption(varStatusOptionsPutStatusOption)
