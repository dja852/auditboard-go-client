...
func (o *NarrativesPutNarrative) UnmarshalJSON(data []byte) (err error) {
	...
	varNarrativesPutNarrative := _NarrativesPutNarrative{}

	decoder := json.NewDecoder(bytes.NewReader(data))
	decoder.DisallowUnknownFields()
	err = decoder.Decode(&varNarrativesPutNarrative)

	if err != nil {
		return err
	}

	*o = NarrativesPutNarrative(varNarrativesPutNarrative)
