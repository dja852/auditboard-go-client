...
func (o *EsgMetricValuesPutEsgMetricValue) UnmarshalJSON(data []byte) (err error) {
	...
	varEsgMetricValuesPutEsgMetricValue := _EsgMetricValuesPutEsgMetricValue{}

	decoder := json.NewDecoder(bytes.NewReader(data))
	decoder.DisallowUnknownFields()
	err = decoder.Decode(&varEsgMetricValuesPutEsgMetricValue)

	if err != nil {
		return err
	}

	*o = EsgMetricValuesPutEsgMetricValue(varEsgMetricValuesPutEsgMetricValue)
