...
func (o *EsgMetricUnitOptions) UnmarshalJSON(data []byte) (err error) {
	...
	varEsgMetricUnitOptions := _EsgMetricUnitOptions{}

	decoder := json.NewDecoder(bytes.NewReader(data))
	decoder.DisallowUnknownFields()
	err = decoder.Decode(&varEsgMetricUnitOptions)

	if err != nil {
		return err
	}

	*o = EsgMetricUnitOptions(varEsgMetricUnitOptions)
