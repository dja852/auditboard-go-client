...
// checks if the BusinessUnits type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &BusinessUnits{}
...
type _BusinessUnits BusinessUnits
...
func (o BusinessUnits) MarshalJSON() ([]byte, error) {
...
func (o BusinessUnits) ToMap() (map[string]interface{}, error) {
...
func (o *BusinessUnits) UnmarshalJSON(data []byte) (err error) {
	...
	varBusinessUnits := _BusinessUnits{}

	decoder := json.NewDecoder(bytes.NewReader(data))
	decoder.DisallowUnknownFields()
	err = decoder.Decode(&varBusinessUnits)

	if err != nil {
		return err
	}

	*o = BusinessUnits(varBusinessUnits)

	return err
}

type NullableBusinessUnits struct {
	value *BusinessUnits
	isSet bool
}

func (v NullableBusinessUnits) Get() *BusinessUnits {
	return v.value
}

func (v *NullableBusinessUnits) Set(val *BusinessUnits) {
	v.value = val
	v.isSet = true
}

func (v NullableBusinessUnits) IsSet() bool {
	return v.isSet
}

func (v *NullableBusinessUnits) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableBusinessUnits(val *BusinessUnits) *NullableBusinessUnits {
	return &NullableBusinessUnits{value: val, isSet: true}
}

func (v NullableBusinessUnits) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableBusinessUnits) UnmarshalJSON(src []byte) error {
	v.isSet = true
