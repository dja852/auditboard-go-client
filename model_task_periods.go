...
// checks if the TaskPeriods type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &TaskPeriods{}

// TaskPeriods struct for TaskPeriods
...
func (o TaskPeriods) MarshalJSON() ([]byte, error) {
...
func (o TaskPeriods) ToMap() (map[string]interface{}, error) {
...
func (o *TaskPeriods) UnmarshalJSON(data []byte) (err error) {
	...
	varTaskPeriods := _TaskPeriods{}

	decoder := json.NewDecoder(bytes.NewReader(data))
	decoder.DisallowUnknownFields()
	err = decoder.Decode(&varTaskPeriods)

	if err != nil {
		return err
	}

	*o = TaskPeriods(varTaskPeriods)

	return err
}

type NullableTaskPeriods struct {
	value *TaskPeriods
	isSet bool
}

func (v NullableTaskPeriods) Get() *TaskPeriods {
	return v.value
}

func (v *NullableTaskPeriods) Set(val *TaskPeriods) {
	v.value = val
	v.isSet = true
}

func (v NullableTaskPeriods) IsSet() bool {
	return v.isSet
}

func (v *NullableTaskPeriods) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableTaskPeriods(val *TaskPeriods) *NullableTaskPeriods {
	return &NullableTaskPeriods{value: val, isSet: true}
}

func (v NullableTaskPeriods) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableTaskPeriods) UnmarshalJSON(src []byte) error {
	v.isSet = true
