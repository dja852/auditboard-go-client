...
// checks if the UsersPutUser type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &UsersPutUser{}

// UsersPutUser struct for UsersPutUser
type UsersPutUser struct {
...
type _UsersPutUser UsersPutUser
...
func (o UsersPutUser) MarshalJSON() ([]byte, error) {
...
func (o UsersPutUser) ToMap() (map[string]interface{}, error) {
...
func (o *UsersPutUser) UnmarshalJSON(data []byte) (err error) {
	...
	varUsersPutUser := _UsersPutUser{}

	decoder := json.NewDecoder(bytes.NewReader(data))
	decoder.DisallowUnknownFields()
	err = decoder.Decode(&varUsersPutUser)

	if err != nil {
		return err
	}

	*o = UsersPutUser(varUsersPutUser)

	return err
}

type NullableUsersPutUser struct {
	value *UsersPutUser
	isSet bool
}

func (v NullableUsersPutUser) Get() *UsersPutUser {
	return v.value
}

func (v *NullableUsersPutUser) Set(val *UsersPutUser) {
	v.value = val
	v.isSet = true
}

func (v NullableUsersPutUser) IsSet() bool {
	return v.isSet
}

func (v *NullableUsersPutUser) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableUsersPutUser(val *UsersPutUser) *NullableUsersPutUser {
	return &NullableUsersPutUser{value: val, isSet: true}
}

func (v NullableUsersPutUser) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableUsersPutUser) UnmarshalJSON(src []byte) error {
	v.isSet = true
