...
func (o *RegionsPutRegion) UnmarshalJSON(data []byte) (err error) {
	...
	varRegionsPutRegion := _RegionsPutRegion{}

	decoder := json.NewDecoder(bytes.NewReader(data))
	decoder.DisallowUnknownFields()
	err = decoder.Decode(&varRegionsPutRegion)

	if err != nil {
		return err
	}

	*o = RegionsPutRegion(varRegionsPutRegion)
