...
func (o *ActionPlansArchives) UnmarshalJSON(data []byte) (err error) {
	...
	varActionPlansArchives := _ActionPlansArchives{}

	decoder := json.NewDecoder(bytes.NewReader(data))
	decoder.DisallowUnknownFields()
	err = decoder.Decode(&varActionPlansArchives)

	if err != nil {
		return err
	}

	*o = ActionPlansArchives(varActionPlansArchives)
