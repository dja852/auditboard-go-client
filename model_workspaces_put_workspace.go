...
func (o *WorkspacesPutWorkspace) UnmarshalJSON(data []byte) (err error) {
	...
	varWorkspacesPutWorkspace := _WorkspacesPutWorkspace{}

	decoder := json.NewDecoder(bytes.NewReader(data))
	decoder.DisallowUnknownFields()
	err = decoder.Decode(&varWorkspacesPutWorkspace)

	if err != nil {
		return err
	}

	*o = WorkspacesPutWorkspace(varWorkspacesPutWorkspace)
