...
// checks if the FrameworkItemsPutPreviousValues type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &FrameworkItemsPutPreviousValues{}

// FrameworkItemsPutPreviousValues struct for FrameworkItemsPutPreviousValues
type FrameworkItemsPutPreviousValues struct {
	...
	MinimumRequirementLevel *string `json:"minimum_requirement_level,omitempty"`
...
func NewFrameworkItemsPutPreviousValues() *FrameworkItemsPutPreviousValues {
	this := FrameworkItemsPutPreviousValues{}
...
// GetMinimumRequirementLevel returns the MinimumRequirementLevel field value if set, zero value otherwise.
func (o *FrameworkItemsPutPreviousValues) GetMinimumRequirementLevel() string {
	if o == nil || IsNil(o.MinimumRequirementLevel) {
		var ret string
		return ret
	}
...
// GetMinimumRequirementLevelOk returns a tuple with the MinimumRequirementLevel field value if set, nil otherwise
// and a boolean to check if the value has been set.
...
// SetMinimumRequirementLevel gets a reference to the given string and assigns it to the MinimumRequirementLevel field.
...
func (o FrameworkItemsPutPreviousValues) MarshalJSON() ([]byte, error) {
...
func (o FrameworkItemsPutPreviousValues) ToMap() (map[string]interface{}, error) {
	...
	if !IsNil(o.MinimumRequirementLevel) {
...
type NullableFrameworkItemsPutPreviousValues struct {
	value *FrameworkItemsPutPreviousValues
	isSet bool
}

func (v NullableFrameworkItemsPutPreviousValues) Get() *FrameworkItemsPutPreviousValues {
	return v.value
}

func (v *NullableFrameworkItemsPutPreviousValues) Set(val *FrameworkItemsPutPreviousValues) {
	v.value = val
	v.isSet = true
}

func (v NullableFrameworkItemsPutPreviousValues) IsSet() bool {
	return v.isSet
}

func (v *NullableFrameworkItemsPutPreviousValues) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableFrameworkItemsPutPreviousValues(val *FrameworkItemsPutPreviousValues) *NullableFrameworkItemsPutPreviousValues {
	return &NullableFrameworkItemsPutPreviousValues{value: val, isSet: true}
}

func (v NullableFrameworkItemsPutPreviousValues) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableFrameworkItemsPutPreviousValues) UnmarshalJSON(src []byte) error {
	v.isSet = true
