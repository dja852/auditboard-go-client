...
func (o *TestSectionsPutTestSection) UnmarshalJSON(data []byte) (err error) {
	...
	varTestSectionsPutTestSection := _TestSectionsPutTestSection{}

	decoder := json.NewDecoder(bytes.NewReader(data))
	decoder.DisallowUnknownFields()
	err = decoder.Decode(&varTestSectionsPutTestSection)

	if err != nil {
		return err
	}

	*o = TestSectionsPutTestSection(varTestSectionsPutTestSection)
