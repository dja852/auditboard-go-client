...
func (o *RcwRequestCategoriesPutRcwRequestCategory) UnmarshalJSON(data []byte) (err error) {
	...
	varRcwRequestCategoriesPutRcwRequestCategory := _RcwRequestCategoriesPutRcwRequestCategory{}

	decoder := json.NewDecoder(bytes.NewReader(data))
	decoder.DisallowUnknownFields()
	err = decoder.Decode(&varRcwRequestCategoriesPutRcwRequestCategory)

	if err != nil {
		return err
	}

	*o = RcwRequestCategoriesPutRcwRequestCategory(varRcwRequestCategoriesPutRcwRequestCategory)
