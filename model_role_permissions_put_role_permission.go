...
func (o *RolePermissionsPutRolePermission) UnmarshalJSON(data []byte) (err error) {
	...
	varRolePermissionsPutRolePermission := _RolePermissionsPutRolePermission{}

	decoder := json.NewDecoder(bytes.NewReader(data))
	decoder.DisallowUnknownFields()
	err = decoder.Decode(&varRolePermissionsPutRolePermission)

	if err != nil {
		return err
	}

	*o = RolePermissionsPutRolePermission(varRolePermissionsPutRolePermission)
