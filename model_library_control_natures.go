...
// checks if the LibraryControlNatures type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &LibraryControlNatures{}

// LibraryControlNatures struct for LibraryControlNatures
type LibraryControlNatures struct {
...
type _LibraryControlNatures LibraryControlNatures
...
func (o LibraryControlNatures) MarshalJSON() ([]byte, error) {
...
func (o LibraryControlNatures) ToMap() (map[string]interface{}, error) {
...
func (o *LibraryControlNatures) UnmarshalJSON(data []byte) (err error) {
	...
	varLibraryControlNatures := _LibraryControlNatures{}

	decoder := json.NewDecoder(bytes.NewReader(data))
	decoder.DisallowUnknownFields()
	err = decoder.Decode(&varLibraryControlNatures)

	if err != nil {
		return err
	}

	*o = LibraryControlNatures(varLibraryControlNatures)

	return err
}

type NullableLibraryControlNatures struct {
	value *LibraryControlNatures
	isSet bool
}

func (v NullableLibraryControlNatures) Get() *LibraryControlNatures {
	return v.value
}

func (v *NullableLibraryControlNatures) Set(val *LibraryControlNatures) {
	v.value = val
	v.isSet = true
}

func (v NullableLibraryControlNatures) IsSet() bool {
	return v.isSet
}

func (v *NullableLibraryControlNatures) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableLibraryControlNatures(val *LibraryControlNatures) *NullableLibraryControlNatures {
	return &NullableLibraryControlNatures{value: val, isSet: true}
}

func (v NullableLibraryControlNatures) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableLibraryControlNatures) UnmarshalJSON(src []byte) error {
	v.isSet = true
